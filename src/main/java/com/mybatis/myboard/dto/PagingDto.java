...
public class PagingDto {
    ...
    public void setQueryString(Map<String, String[]> queryMap) {
        ...
        // th:href=@{'url'(name=1, name=2)} -> url?name=1&name=2
        // list.do -> th:href=@{''(page=${i})} -> list?page=3
        // list.do -> th:href=@{('?'+'rows=10&order=user_id&')(page=${i})} -> list.do?rows=10&order=user_id&&page=3
